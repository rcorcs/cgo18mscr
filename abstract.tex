\begin{abstract}
    ...
    Our online iterative compilation method yields programs that get \FIXME{80\%} of the speedup achievable by an offline oracle, 
    but without executing any input more than once, which the oracle cannot do. 
    Through probe removal we bring the instrumentation overhead down to only \FIXME{4\%} on average, making our
