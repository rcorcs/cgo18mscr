\begin{abstract}
    ...
    Unless we find a way to compare optimizations even when inputs are restricted to execute only once, we will be unable to apply 
    iterative compilation in online scenarios with real user inputs, users will not have the best optimized programs, and performance will suffer.
    ...
    Our online iterative compilation method yields programs that get 60\% of the speedup achievable by an offline oracle,
