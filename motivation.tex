...
%%    hurt average performance instead.
    ...
    \paragraph{Existing efficiency metrics are not up to the task.} Application-specific efficiency metrics such as the number of transactions per second may
