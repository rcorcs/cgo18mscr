\section{Introduction}
    ...
    choose the best settings. Programs compiled at \texttt{-O3} might be \FIXME{50\%} slower or worse than those compiled with the best
    settings~\FIXME{\cite{??}}. Iterative, or adaptive, compilation searches for the best compilation settings. Program versions are run
