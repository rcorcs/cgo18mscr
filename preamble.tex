...
\newcommand{\OracleRM}{{Oracle-RM}\xspace}
\newcommand{\OraclePP}{{Oracle-PP}\xspace}
\newcommand{\OptProf}{{Opt-Profiling}\xspace}
\newcommand{\WCRelax}{WC-Relax}
\newcommand{\WPRelax}{WP-Relax}
