...
Although the user may experience slowdown during the optimization process, due to overheads or by executing sub-optimal versions of the program, after the first generation,
the optimization sequences produced tend to overcome these costs, with their benefits surpassing the profiling overheads.
...
%\begin{figure*}[t]
%  \centering
%  \subfigure[Opt-Profiling]{\includegraphics[width=0.3\textwidth]{figs/Opt-Profiling-deployment.pdf}}
%  \subfigure[WC-Relax-5]{\includegraphics[width=0.3\textwidth]{figs/WC-Relax-5-deployment.pdf}}
%  \subfigure[WP-Relax-5]{\includegraphics[width=0.3\textwidth]{figs/WP-Relax-5-deployment.pdf}}
