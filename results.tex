...
\subsubsection{Cost Evaluation During the Online Search}
...
To this end we used the architecture described in Section~\ref{sec:oic-infra} with the search based on genetic algorithm~\cite{knijnenburg02,kulkarni04}. %cooper99
...
We evaluate the deployment cost for the three configurations that use work profiling, namely \OptProf, \WCRelax-5\%, and \WPRelax-5\%.
