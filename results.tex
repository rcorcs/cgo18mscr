...
Profiling strategies used throughout this section 
for measuring either the actual speedup or the work efficiency metric.
...
\subsubsection{\Itercomp Strategies}
...
\item \textbf{Opt-Prof} corresponds to the online {\itercomp} as it would be applied in a real-world online scenario.
