...
We first compare static aspects of the instrumentation algorithms. The naive instrumentation instrument all basic blocks, by definition.
First, we evaluate the optimal work profiling compared to the relaxation algorithm applied per DAG. Afterwards, we compare these profiling
techniques with the whole program relaxation.
