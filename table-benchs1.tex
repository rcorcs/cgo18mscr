...
%\end{subtable}
\caption{Training benchmarks and inputs.}
\caption{Benchmarks used for calibrating the work model. Each program has a dataset of 1,000 distinct inputs.}
...
\caption{Benchmarks used throughout our experimental evaluation.
         Each program has a dataset of 1,000 distinct inputs.}
