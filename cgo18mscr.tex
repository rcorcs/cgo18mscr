...
We propose the use of a work-based performance metric for guiding {\itercomp},
...
Our experimental evaluation shows that the two relaxation algorithms can reduce
the average overhead by 43\% and $2.1\times$ over the optimal work profiling.
