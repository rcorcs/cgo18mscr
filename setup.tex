...
\paragraph{Compiler and Hardware} We implemented our approach in LLVM 4.0\footnote{Download URL hide for anonymous review.}. Our evaluation platform has a \red{xx-core} 3.4 GHz Intel Core i7 CPU with 16 GB of RAM. The
