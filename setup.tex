...
Our approach is implmented in LLVM 4.0 and is open sourced\footnote{Download URL hidden for anonymous review.}. Our evaluation platform has
...
When reporting our results in Section~\ref{sec:results},
...
This same process is used for reporting the measurements in Figures~\ref{fig:overhead-O3},~\ref{fig:error-O3}, and \ref{fig:speedups}.
%\FIXME{PP:Which metric is performance? What is the performance report? What about the plots that are not about performance?}
