...
bar to show the variance across inputs. \FIXME{PP:Which metric is performance? What is the performance report? What about the plots that are not about performance?}
